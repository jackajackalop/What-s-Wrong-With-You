...
function draw() {
  ...
  textAlign(CENTER);
  text(txt, w/2, h*7/8);
  text("The current year is "+ round(2018+E)+ ".\n"+round(E)+" years have elapsed since this page was last refreshed.", w/2, h*7/8 + 16);
...
function isItDead(me,S) {
  ...
  var p = ease["cubicIn"](S/20000);
  me.mms = randomGaussian(me.mms+p,.0000001);
